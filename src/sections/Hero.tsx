...
const Hero = () => {
  ...
  return (
    <section className="hero-section">
      ...
      <div>
        <img src="/images/big-hero.svg" alt="logo" className="size-full object-cover mask-logo" />
      </div>

      <div className="fake-logo-wrapper">
        <img src="/images/big-hero-text.svg" alt="big hero text" className="overlay-logo" />
      </div>
